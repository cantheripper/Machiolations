...
public class EnemyManager {
	...
	public void addEnemy(int enemyType) {
		...
		switch (enemyType) {
		case THANOS:
			enemies.add(new Thanos(x, y, 0, this));
			break;
		case VENOM:
			enemies.add(new Venom(x, y, 0, this));
			break;
		case LOKI:
			enemies.add(new Loki(x, y, 0, this));
			break;
		case JOKER:
			enemies.add(new Joker(x, y, 0, this));
			break;
		}
