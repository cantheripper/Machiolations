...
public class MyMouseListener implements MouseListener, MouseMotionListener {
	...
	public MyMouseListener(Machiolations game) {
		this.game = game;
	}
	...
	public void mouseDragged(MouseEvent e) {
		...
		case MENU:
			...
			break;
		case OYNANIS:
			game.getOynanis().mouseDragged(e.getX(), e.getY());
			break;
		case AYARLAR:
			game.getAyarlar().mouseDragged(e.getX(), e.getY());
			break;
		case EDIT:
	...
	public void mouseMoved(MouseEvent e) {
		...
		case MENU:
			...
			break;
		case OYNANIS:
			game.getOynanis().mouseMoved(e.getX(), e.getY());
			break;
		case AYARLAR:
			game.getAyarlar().mouseMoved(e.getX(), e.getY());
			break;
		case EDIT:
	...
	public void mouseClicked(MouseEvent e) {
		if (e.getButton() == MouseEvent.BUTTON1) {
			...
			case MENU:
				...
				break;
			case OYNANIS:
				game.getOynanis().mouseClicked(e.getX(), e.getY());
				break;
			case AYARLAR:
				game.getAyarlar().mouseClicked(e.getX(), e.getY());
				break;
			case EDIT:
	...
	public void mousePressed(MouseEvent e) {
		...
		case MENU:
			...
			break;
		case OYNANIS:
			game.getOynanis().mousePressed(e.getX(), e.getY());
			break;
		case AYARLAR:
			game.getAyarlar().mousePressed(e.getX(), e.getY());
			break;
		case EDIT:
	...
	public void mouseReleased(MouseEvent e) {
		...
		case MENU:
			...
			break;
		case OYNANIS:
			game.getOynanis().mouseReleased(e.getX(), e.getY());
			break;
		case AYARLAR:
			game.getAyarlar().mouseReleased(e.getX(), e.getY());
			break;
		case EDIT:
