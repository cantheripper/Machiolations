...
//matrix oluşturma 
	public static int[][] Matrix(ArrayList<Integer> list, int ySize, int xSize) {
	...
	public static int[] Matrix2(int[][] twoArr) {
	...
	public static int AradakiMesafe(float x1, float y1, float x2, float y2) {
